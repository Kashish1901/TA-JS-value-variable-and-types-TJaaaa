...
*/
// [Your code goes here]
let max = +prompt("Enter the number of n!");
let sum = 0;
...
*/
// [Your code goes here]
let num = +prompt("Give one number value between 1-10?");
switch (num) {
  case 1:
    alert(`ONE`);
    break;
...
switch ( operation) {
  case add :
    alert (`The sum of ${numOne} and ${numTwo} is ${ numOne + numTwo}`);
    break;
    case sub :
    alert (`The subtraction of ${numOne} and ${numTwo} is ${ numOne + numTwo}`);
    break;
    case mul :
    alert (`The product of ${numOne} and ${numTwo} is ${ numOne + numTwo}`);
    break;
    case div :
